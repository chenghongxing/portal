	...
	<body>
		...
		<div id="pwd_cont">
			<div id="contA">
				<div class="cont_one">
					<span>当前手机号*</span>
					<span class="put">17853668483</span>
					<button id="aclass">短信验证</button>
				</div>
				<div class="cont_one">
					<span>验证码* </span>
					<span class="put_one"><input type="text" name="" id="" value="" placeholder="短信验证码" required="true"/></span>
				</div>
				<div class="cont_one">
					<span>新手机号*</span>
					<span class="put_two"><input type="text" name="" id="" value="" placeholder="新手机号" required="true"/></span>
				</div>
				<div id="cont_tree">
